...
class NetworkTrainer2(object):
    ...
    # think about change here how to balance two kind of samples
    def run_iteration(self, data_generators:list, loss_list:list):
        for data_generator, loss in zip(data_generators, loss_list):
            self.run_iteration_sub(data_generator, loss)

    def run_iteration_sub(self, data_generator, loss, do_backprop=True, run_online_evaluation=False):
